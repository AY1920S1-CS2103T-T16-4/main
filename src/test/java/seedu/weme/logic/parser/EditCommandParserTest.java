...
import static seedu.weme.testutil.TypicalIndexes.INDEX_THIRD_PERSON;
...
public class EditCommandParserTest {
    ...
    public void parse_allFieldsSpecified_success() {
        ...
        EditCommand.EditMemeDescriptor descriptor = new EditPersonDescriptorBuilder().withName(VALID_NAME_AMY)
    ...
    public void parse_oneFieldSpecified_success() {
        ...
        EditCommand.EditMemeDescriptor descriptor = new EditPersonDescriptorBuilder().withName(VALID_NAME_AMY).build();
        EditCommand expectedCommand = new EditCommand(targetIndex, descriptor);
        assertParseSuccess(parser, userInput, expectedCommand);
