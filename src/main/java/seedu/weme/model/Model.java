...
public interface Model {
    ...
    /**
     * Returns the user prefs' meme collection file path.
     */
    Path getMemeBookFilePath();

    /**
     * Sets the user prefs' meme collection file path.
     */
    void setMemeBookFilePath(Path memeBookFilePath);

    /**
     * Replaces meme collection data with the data in {@code memeBook}.
     */
    ...
    /**
     * Returns true if a meme with the same identity as {@code meme} exists in the meme collection.
     */
    boolean hasMeme(Meme meme);

    /**
     * Deletes the given meme.
     * The meme must exist in the meme collection.
     */
    void deleteMeme(Meme target);

    /**
     * Adds the given meme.
     * {@code meme} must not already exist in the meme collection.
     */
    void addMeme(Meme meme);

    /**
     * Replaces the given meme {@code target} with {@code editedMeme}.
     * {@code target} must exist in the meme collection.
     * The meme identity of {@code editedMeme} must not be the same as another existing meme in the meme collection.
     */
