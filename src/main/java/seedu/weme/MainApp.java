...
public class MainApp extends Application {
     ...
     * The data from the sample  will be used instead if {@code storage}'s  is not found,
     * or an empty  will be used instead if errors occur when reading {@code storage}'s .
     */
