...
This feature allows the user to view a meme in the memes tab as a 400x400 picture. This also allows
...
which sets the Meme for the ViewPanel to view. The Meme is retrieved as a ObservableObject<Meme> in the model
by MainWindow, which is passed into the ViewPanel to set the meme to display.
