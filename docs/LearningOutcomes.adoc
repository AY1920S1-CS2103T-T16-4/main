...
e.g. rename the tag `friends` to `buddies` (i.e. all memes who had the `friends` tag will now have
...
----
+
The above method can be used to get a printable string representing a bunch of meme details.
